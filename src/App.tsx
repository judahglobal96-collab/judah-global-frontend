    ...
    <BrowserRouter>
      <Routes>
        ...
        >
          ...
          <Route path="review/:eventId" element={<AdminEventReviewPage />} />
          ...
          <Route path="campaign-payments" element={<AdminEventPaymentsPage />} />
          ...
          <Route path="events/:eventId/paid-promos" element={<PaidPromosPage />} />
          <Route path="event-logs" element={<AdminEventLogsPage />} />
          <Route path="event/:eventId/logs" element={<AdminEventLogsPage />} />
          <Route path="support-lookup" element={<SupportLookupPage />} />
        </Route>
